package br.com.otavio.victor.composetoolkit.ui.theme
...
fun ColorList() {
    Column(
        ...
        mapOf(
            ...
            "customSnowWhite" to ToolKitThemeExtended.colors.snowWhite,
            "customDeepOcean" to ToolKitThemeExtended.colors.deepOcean,
            "customSkyBlue" to ToolKitThemeExtended.colors.skyBlue,
            "customNightBlue" to ToolKitThemeExtended.colors.nightBlue,
            "customDialogBackground" to ToolKitThemeExtended.colors.dialogBackground,
        ).forEach { (text, color) ->
            Row {
                Text(
                    text = text,
                    color = ToolKitThemeExtended.colors.snowWhite,
                    modifier = Modifier
                        .weight(1f)
                )
